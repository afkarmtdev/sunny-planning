...
export const auth = {
  ...
  "auth.cropTitle": { en: "Frame your photo", zh: "调整你的照片", pinyin: "tiao2 zheng3 ni3 de5 zhao4 pian4" },
  "auth.cropHint": { en: "Drag to move, pinch or scroll to zoom", zh: "拖动移动，双指或滚轮缩放", pinyin: "tuo1 dong4 yi2 dong4，shuang1 zhi3 huo4 gun3 lun2 suo1 fang4" },
  "auth.cropZoom": { en: "Zoom", zh: "缩放", pinyin: "suo1 fang4" },
  "auth.usePhoto": { en: "Use photo", zh: "使用照片", pinyin: "shi3 yong4 zhao4 pian4" },
